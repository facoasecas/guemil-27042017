...
<!--segunda fila-->
<div class="row">
  <div class="col-sm-6"><p>Meaning <span lang="es">Significado</span></p></div>
  <div class="col-sm-6"><p><?echo (count($json_data['test']['pictogramas'][$a]['respuestas']))?> Answer <span lang="es">Respuestas</span></p></div>
</div>
<!--tercera fila-->
<div class="row">
    ...
    <div class="col-xs-4 contador"><h5><?php echo ($q4);?></h5><p>Incorrect <span lang="es">| Incorrecta</span></p></div>
    <div class="col-xs-4 contador"><h5><?php echo ($q5);?></h5><p>Opposite meaning <span lang="es">| Significado opuesto</span></p></div>
    <div class="col-xs-4 contador"><h5><?php echo ($q6);?></h5><p><span lang="es">| Sin Respuesta</span></p></div>
</div>
<p>Action <span lang="es">Acción</span></p>
